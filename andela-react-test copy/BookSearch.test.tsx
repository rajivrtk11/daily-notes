...
const { getAllByTestId, getByTestId, getByDisplayValue } = screen;
...
describe("BookSearch", () => {
  ...
  beforeAll(async () => {
    booksData = await readFile("./sample_data/books.json", "utf-8");
  });
  ...
  describe("searching by each field alone", () => {
    ...
    describe("modifying the country field", () => {
      ...
      it("should filter books by country", () => {
        const bookEls = getAllByTestId("book");
  ...
  describe("filtering on multiple terms", () => {
    describe("filtering on 192_ and english", () => {
      ...
      it("should filter books by year and language", () => {
        const bookEls = getAllByTestId("book");
        expect(bookEls).toHaveLength(4);
    ...
    describe("filtering on all fields with trim", () => {
      ...
      it("should filter books by all fields", () => {
        const bookEls = getAllByTestId("book");
    ...
    describe("filtering on terms that have no results", () => {
      ...
      it("should return no books if no results match", () => {
